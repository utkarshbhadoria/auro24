  ...
  return (
    <div className='h-screen h-full flex flex-col shadow-sm rounded-3xl m-2 bg-gray-900 overflow-y-auto'>
       ...
       <div className='flex flex-col flex-grow justify-between pt-5'>
        ...
        <li>  
            <div className={`flex pl-4 pt-2 pb-2 ${pathname.includes("/dashboard") ? 'bg-blue-500 rounded-xl' : ''}`}>
          ...
          <li>
            <div className={`flex pl-4 pt-2 pb-2 ${pathname.includes("/userManagement") ? 'bg-blue-500 rounded-xl' : ''}`}>
                  ...
                  return(
                    <React.Fragment>
                      ...
                      <ul className={`${!(open && expanded) ? 'hidden' : ''} pt-5 p-3`}>
                        ...
                        <li className={`p-1 pl-3 mr-2 ${pathname.includes("/deviceUnassigned") ? 'bg-blue-500 rounded-xl' : ''}`}><NavLink to='/deviceUnassigned'>Unassigned</NavLink></li>
                      </ul>
                    </React.Fragment>
                  )
                }}
          ...
          <li>
            <div className={`flex pl-4 pt-2 pb-2 ${pathname.includes("/appManagement") ? 'bg-blue-500 rounded-xl' : ''}`}>
          ...
          <li>
            <div className={`flex pl-4 pt-2 pb-2 ${pathname.includes("/geofence") ? 'bg-blue-500 rounded-xl' : ''}`}>
          ...
          <li>  
           <div className={`flex pl-4 pt-2 pb-2 ${pathname.includes("/wifiNetwork") ? 'bg-blue-500 rounded-xl' : ''}`}>
          ...
          <li>  
            <div className={`flex pl-4 pt-2 pb-2 ${pathname.includes("/compilance") ? 'bg-blue-500 rounded-xl' : ''}`}>
          ...
          <li>  
            <div className={`flex pl-4 pt-2 pb-2 ${pathname.includes("/reports") ? 'bg-blue-500 rounded-xl' : ''}`}>
          ...
          <li>   
            <div className={`flex pl-4 pt-2 pb-2 ${pathname.includes("/logs") ? 'bg-blue-500 rounded-xl' : ''}`}>
